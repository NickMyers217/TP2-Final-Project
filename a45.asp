...
<body>
		...
		<div class="row">
			<div class="col-lg-6 col-lg-offset-3">
				<div class="well bs-component">
					...
					<form class="form-horizontal" action="a45.asp" method="POST">
						<fieldset>

							<legend class="text text-primary">Enter a glmaster account ID to query.</legend>
	...
	sub pass2
		...
		sql = "SELECT * FROM glmaster WHERE major = " + request.form("major") + " AND "
