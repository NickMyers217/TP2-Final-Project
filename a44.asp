...
<body>
	...
	================================================== -->
		<%
			...
			sql_string = "SELECT * FROM glmaster ORDER BY major, minor, sub1, sub2"
			...
			while not rs.EOF
				...
				next
				'Total Column
				response.write "<td>" + cstr(FormatCurrency(bal)) + "</td>"
				response.write "</tr>"
			...
			response.write "<tr>"
			response.write "<td colspan = '6'>Total Balance</td>"
			response.write "<td>" + cstr(FormatCurrency(bal)) + "</td>"
			response.write "</tr>"
